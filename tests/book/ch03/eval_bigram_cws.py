...
# 参考https://blog.csdn.net/Changxing_J/article/details/105990294  武雅琴
from pyhanlp import *
...
CWSEvaluator = SafeJClass('com.hankcs.hanlp.seg.common.CWSEvaluator')#pyhanlp的API调用 ，加载JAVA模块

if __name__ == '__main__':
    train_bigram(msr_train, msr_model)  # 训练
    segment = load_bigram(msr_model)  # 加载
    print(segment)
    CWSEvaluator.evaluate(segment, msr_test, msr_output, msr_gold, msr_dict)  # 预测打分
